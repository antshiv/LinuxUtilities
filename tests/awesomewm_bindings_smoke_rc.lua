...
assert(find_key(binding_tables.globalkeys, "space", "universal LinuxUtilities launcher") ~= nil)
...
find_key(binding_tables.globalkeys, "space", "universal LinuxUtilities launcher").callback()
...
find_key(binding_tables.globalkeys, "r", "universal LinuxUtilities launcher").callback()
...
assert(launcher_calls.launcher == 2)
